      ...
      <div class="drill-panel" data-property-panel="${propId}">
        ...
        <div class="drill-grid drill-grid--4">
          ...
          <div class="drill-card drill-card--chart" data-metric="tradeOut" data-prop="${propId}">
            ...
            <div class="drill-card__value-multi">
              <div class="trade-line"><span class="trade-label">New Lease</span><span class="trade-value" style="color:var(--success)">+2.1%</span></div>
              <div class="trade-line"><span class="trade-label">Renewal</span><span class="trade-value" style="color:var(--success)">+3.5%</span></div>
              <div class="trade-line trade-line--total"><span class="trade-label">Total Avg</span><span class="trade-value" style="color:${prop.newTradeOut >= 0 ? 'var(--success)' : prop.newTradeOut != null ? 'var(--danger)' : 'inherit'}">${prop.newTradeOut != null ? (prop.newTradeOut >= 0 ? '+' : '') + (prop.newTradeOut * 100).toFixed(1) + '%' : '—'}</span></div>
            </div>
            <div class="drill-card__view drill-card__view--active" data-view-content="graph">
        ...
        <div class="funnel-section">
          ...
          <div class="funnel-bar">
            <div class="funnel-step"><div class="funnel-step__label">Clicks</div><div class="funnel-step__value">${clicks}</div><div class="funnel-step__pct">—</div></div>
            <div class="funnel-arrow">→</div>
            <div class="funnel-step"><div class="funnel-step__label">Tours</div><div class="funnel-step__value">${traffic}</div><div class="funnel-step__pct">${trafPct}%</div></div>
            <div class="funnel-arrow">→</div>
            <div class="funnel-step"><div class="funnel-step__label">Apps</div><div class="funnel-step__value">${apps}</div><div class="funnel-step__pct">${appPct}%</div></div>
            <div class="funnel-arrow">→</div>
            <div class="funnel-step"><div class="funnel-step__label">Leases</div><div class="funnel-step__value">${leases}</div><div class="funnel-step__pct">${leasePct}%</div></div>
          </div>
        </div>
